...
export default function AdminShell({
  ...
  return (
    <AdminIdentityContext.Provider value={identity}>
      {/*
        AdminRealtimeProvider supplies the administrative realtime context subtree.
        In this release, real-time connectivity remains disconnected as a compatibility API
        without opening an unsupported EventSource or WebSocket connection.
      */}
