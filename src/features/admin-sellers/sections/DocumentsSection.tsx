    ...
    <div className="flex items-center justify-between gap-4 px-4 py-3 transition-colors hover:bg-stone-50/50">
      <div className="flex shrink-0 items-center gap-3.5">
        {hasUrl ? (
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="group relative block h-10 w-14 shrink-0 overflow-hidden rounded-md border border-stone-200/60 bg-stone-100 shadow-sm transition hover:shadow-md"
          >
      ...
      {hasUrl ? (
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="inline-flex shrink-0 items-center gap-1.5 rounded-lg border border-stone-200/60 bg-white px-2.5 py-1.5 text-[10px] font-black uppercase tracking-wider text-stone-700 shadow-sm transition hover:bg-stone-50"
        >
